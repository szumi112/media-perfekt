...
const ContactModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-gray-800 rounded-lg shadow-lg w-[90%] sm:w-[80%] md:w-[60%] lg:w-[40%] xl:w-[30%] p-6 relative">
        <button
          className="absolute top-2 right-2 text-gray-100 w-8 h-8 bg-gray-500 rounded-md hover:text-white hover:bg-red-500"
          onClick={onClose}
        >
          x
        </button>
        ...
        <div className="mb-6 text-gray-300">
          ...
          <p className="flex">
            <strong className="mr-3 text-gray-500">
